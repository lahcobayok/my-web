        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link active" href="admin.php">Daftar admin</a></li>
                    <li class="nav-item"><a class="nav-link" href="admin.php?page=daftar_karyawan">Daftar karyawan</a></li>
                    <li class="nav-item"><a class="nav-link" href="admin.php?page=daftar_service">Daftar_service</a></li>
                </ul>
                <a class="btn btn-info shadow" role="button" href="admin.php?page=proses_keluar">Log out</a>
            </div>
        </div>
    </nav>
    <div class="d-flex justify-content-center">
        ...
        if (isset($_GET['page'])) {
            if ($_GET['page'] == 'daftar_user') {
                ...
                include 'controllers/proses1.php';
            } elseif ($_GET['page'] == 'proses2') {

                include 'controllers/proses2.php';
            }
        } else {

                    ...
                    <tbody>
                        ...
                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" class="btn btn-outline-danger" type="button" href="admin.php?page=proses_hapus&id=<?php echo $pecah['id']; ?>">Delete</a>
                                </td>

...
<head>
    ...
    <title>Online Workshop Fadialh</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.php?page=service">Service</a></li>
                    <li class="nav-item"><a class="nav-link" href="index.php?page=form">Form service</a></li>
                ...
                </ul><a class="btn btn-primary shadow" role="button" href="index.php?page=login">Log in admin</a>
            </div>
        </div>
    </nav>
    <div class="d-flex justify-content-center">
        ...
        if (isset($_GET['page'])) {
            ...
            } elseif ($_GET['page'] == 'proses_simpan') {

                include "src/controller/action_input_data.php";
            }
        } else {
            include 'home.php';
        }
        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                    ...
                    <p class="text-muted">SMK FADILAH Menyediakan Fasilitas Online Workshop.</p>
                </div>
            </div>
            <hr>
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © 2023 Online Workshop</p>
